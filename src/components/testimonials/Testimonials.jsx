...
const data = [
  {
    avatar: AVTR1,
    name: 'Dorcas Bami',
    review: 'He listen, pay attention to details and also try everything to give you whatever your desire is when it comes to having a web; lumiCode is a wonder man:'
  },
  {
    avatar: AVTR2,
    name: 'Chris Wale',
